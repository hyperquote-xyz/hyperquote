...
| Block Explorer | [HyperScan](https://hyperscan.xyz) |
...
Quote signatures use EIP-712 typed data. The domain must match across the relay, SDK, and on-chain contracts:

| Contract | `name` | `version` | `chainId` | `verifyingContract` |
|----------|--------|-----------|-----------|---------------------|
| **SpotRFQ** | `"HyperQuote"` | `"1"` | `999` | [`0x9A09592fc19F1e55FC36B8D9b47EBbc4B3207017`](https://hyperscan.xyz/address/0x9A09592fc19F1e55FC36B8D9b47EBbc4B3207017) |
| **OptionsEngine** | `"HyperQuote Options"` | `"1"` | `999` | OptionsEngine address |
