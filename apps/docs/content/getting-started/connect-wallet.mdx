...
| Wrong chain ID | Switch to HyperEVM (chain ID `999`) in your wallet's network settings. |
| RPC errors | Check that your wallet's RPC URL for HyperEVM is `https://rpc.hyperliquid.xyz/evm`. |
